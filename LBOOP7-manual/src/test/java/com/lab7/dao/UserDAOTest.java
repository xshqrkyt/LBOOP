...
public class UserDAOTest {
    ...
    public void setup() throws SQLException, IOException {
        ...
        String table = new String(Files.readAllBytes(Paths.get("src/main/resources/scripts/tables/users_table.sql")));
    ...
    @Test
    public void notExistUserFind() throws SQLException, IOException {
    ...
    @Test
    public void findCriteriaTest() throws SQLException, IOException {
        ...
        var resultEmail = dao.findCriteria("special@example.com", null);
        ...
        var resultRole = dao.findCriteria(null, UserRole.ADMIN);
        ...
        var resultEmailRole = dao.findCriteria("special@example.com", UserRole.ADMIN);
        ...
        var allUsers = dao.findCriteria(null, null);
        assertTrue(allUsers.size() >= 6);
    }

    @Test
    public void testFindByUsernameSorted() throws SQLException, IOException {
