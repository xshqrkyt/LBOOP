...
@Slf4j
@RestController
@RequestMapping("/lab6-1.0-SNAPSHOT/composite-function-links")
...
public class CompositeFunctionLinkController {
    ...
    @PutMapping
    public ResponseEntity<CompositeFunctionLinkResponse> update(@RequestParam Long id, @RequestBody CompositeFunctionLinkRequest request) {
