...
public class MapperTest {
    ...
    public void userRequestTest() {
        ...
        UserRequest request = new UserRequest("user576", "12345", "user576@example.com", UserRole.ADMIN);
    ...
    public void compositeFunctionResponseTest() {
        CompositeFunction compositeFunction = new CompositeFunction(57687L, "CompositeFunction", LocalDateTime.now(), 123L);
